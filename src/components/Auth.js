...
import { chalneDoLogo } from "../utils/constants.js";

import { addUser } from "../store/userSlice";

const Auth = () => {
  console.log(chalneDoLogo);
  ...
  return (
    <div className="relative min-h-[100vh] before:bg-black before:z-30 before:opacity-50 before:absolute before:h-full before:w-full before:left-0 before:top-0">
      ...
      >
        ...
        <button
          type="submit"
          className="p-2  bg-linear-to-r from-[#EE10B0] to-[#0E9EEF]/92 cursor-pointer rounded"
        >
          Sign {isSignUpForm ? "Up" : "In"}
        </button>
        <div className="text-sm flex gap-2">
          <p>{isSignUpForm ? "Already registered" : "New to Chalne Do"}?</p>
          <button
            type="button"
